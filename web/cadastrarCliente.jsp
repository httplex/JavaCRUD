        ...
        <div id="container">
            ...
            <div id="conteudo" class="bg-background"> 
                <form action="gerenciarCliente" method="POST">
                    <h3 class="text-center mt-5" style="padding-top: 30px">Cadastro de Cliente</h3>
                    ...
                    <div class="form-group row offset-md-2">
                        <label for="idcontato" 
                               class="col-md-3 col-form-label-lg">Contato</label>
                        <div class="col-md-5">
                            <input type="text" name="contato" id="idcontato" 
                                   class="form-control" value="${cliente.contato}">
                        </div>
                    </div>
